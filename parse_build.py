...
try:
  tree = ET.parse(sys.argv[1])#pass the xml files's path as 1st cmd line arg
  root = tree.getroot()
  ...
  os.environ['JENKINS_URL']="https://build.isafe-mobile.com/job/"+sys.argv[2]+"/"+build_num+"/" #pass '..andoid720' part of url as 2nd cmd line arg
